...
def process_transactions(file):
    ...
    for refid, group in grouped_trades:
        ...
        print(f"RefID: {refid}, Group Profit/Loss: ${total_profit:.2f}")

    return initial_wallet_balance, final_wallet_balance, total_profit, profits, daily_profits, open_trades

def print_results(initial_wallet_balance, final_wallet_balance, total_profit, profits, daily_profits, open_trades):
    print(f"\nInitial Wallet Balance: ${initial_wallet_balance:.2f}")
    print(f"Final Wallet Balance: ${final_wallet_balance:.2f}")
    print(f"Total Profit/Loss: ${total_profit:.2f}\n")
    
    print("Profit by Coins:")
...
if __name__ == "__main__":
    ...
    initial_wallet_balance, final_wallet_balance, total_profit, profits, daily_profits, open_trades = process_transactions(input_file)
    
    # Print the results
    print_results(initial_wallet_balance, final_wallet_balance, total_profit, profits, daily_profits, open_trades)
