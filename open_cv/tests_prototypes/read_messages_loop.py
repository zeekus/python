#!/usr/bin/python3
#filename: read_messages_loop.py
#descrption: program uses open computer vision to determine the messages on the screen.
#this is a prototype 
...
def  loop_through_messages(file):
  ...
  for i in data:
    ...
    path=os.getcwd()
    full_path_file=(path + "/messages/" + filename)
...
path=os.getcwd()
message_json=(path + "/messages/messages.json")
