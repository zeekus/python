...
#!/usr/bin/python3
#filename: rotate_screen_until_to_top_right_is_dark.py
...
rotate_screen=sample_right_top_of_screen()
digital_voice(f"rotate_screen is {rotate_screen}")

while( rotate_screen == 1):
