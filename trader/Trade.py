...
class Trade:
    def __init__(self, date, crypto_asset, crypto_amount, usd_amount, crypto_fee, usd_fee, crypto_balance):
        self.date = date
    ...
    def print_trade(self, line_number):
        ...
        print(f'   Crypto Fee: {self.crypto_fee:.8f} {self.crypto_asset}')
        print(f'   USD Fee: {self.usd_fee:.2f} USD')
